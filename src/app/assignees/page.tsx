    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Assignees</h1>
        ...
        <Modal
          ...
          title={editing ? 'Edit Assignee' : 'Add New Assignee'}
          size="md"
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t">
              ...
              >
                {editing ? 'Update Assignee' : 'Create Assignee'}
              </button>
            </div>
          </form>
        </Modal>
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            {assignees.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">No assignees</h3>
                <p className="mt-1 text-sm text-gray-500">Get started by creating a new assignee.</p>
                <div className="mt-6">
                  <button
                    onClick={openModal}
                    ...
                    {paginatedAssignees.map((assignee) => (
                      <tr key={assignee.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-semibold text-gray-900">{assignee.name}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-600">{assignee.email || <span className="text-gray-400">—</span>}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-600">{assignee.phone || <span className="text-gray-400">—</span>}</div>
                        </td>
